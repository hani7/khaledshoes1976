...
FRONTEND_URL = os.environ.get('FRONTEND_URL', 'https://khaledshoes.dz')
API_URL = os.environ.get('API_URL', 'https://api.khaledshoes.dz')
...
WSGI_APPLICATION = 'khaled.wsgi.application'
...
django.template.context.RequestContext.__copy__ = _patched_copy
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'khaled.pagination.FlexiblePagination',
    'PAGE_SIZE': 20,
...
# ─── YALIDINE DELIVERY API ──────────────────────────────────────────────────────
YALIDINE_BASE_URL = os.environ.get('YALIDINE_BASE_URL', 'https://api.yalidine.app/v1/')
YALIDINE_API_ID = os.environ.get('YALIDINE_API_ID')
YALIDINE_API_TOKEN = os.environ.get('YALIDINE_API_TOKEN')
