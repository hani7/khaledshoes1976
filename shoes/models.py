...
class ProductVariant(models.Model):
    ...
    # Collection support: group variants under a named choice (e.g. "Choix 01", "Choix 02")
    # Leave blank for regular (non-collection) variants.
...
class Order(models.Model):
    ...
    yalidine_tracking = models.CharField(max_length=100, blank=True, verbose_name='Tracking Yalidine')
    yalidine_status = models.CharField(max_length=200, blank=True, verbose_name='Statut Yalidine')
