...
class UserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserProfile
        fields = ['phone', 'address', 'wilaya', 'loyalty_points']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'yalidine_tracking', 'yalidine_status'
        ]
        read_only_fields = ['user', 'status', 'total', 'created_at', 'delivery_cost', 'delivery_company_name', 'history', 'yalidine_tracking', 'yalidine_status']
...
class AdminOrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['user', 'total', 'created_at', 'updated_at', 'items', 'history', 'delivery_cost', 'delivery_company_name', 'is_blacklisted', 'yalidine_tracking', 'yalidine_status', 'is_deleted', 'deleted_at', 'deleted_by_name', 'boutique_name', 'boutique_transferred_at']
