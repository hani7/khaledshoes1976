...
export default function ProductPage() {
  ...
  const handleAddToCart = useCallback(() => {
    if (isCollection) {
      ...
      addItem(product, null, quantity, 'boite', choicesArray);
      
    } else {
      addItem(product, selectedVariant, quantity, 'boite')
    ...
    setSelectedRelated([])
  }, [product, selectedVariant, quantity, selectedRelated, isCollection, selectedChoices, allChoicesMade, choiceGroupLabels.length, displayPrice, addItem])
