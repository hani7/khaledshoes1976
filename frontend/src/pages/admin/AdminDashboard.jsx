      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: 24, marginBottom: 28 }}>
        ...
        <div className="admin-card">
          <div className="admin-card-header" style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <Link to="/kh-secure-2026/orders" style={{ fontSize: '0.8rem', color: 'var(--color-primary)', textDecoration: 'none', fontWeight: 500 }}>Voir tout</Link>
          </div>
          <div style={{ padding: 0 }}>
              ...
              <AreaChart data={data.trends}>
                <defs>
                  <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#f2b01e" stopOpacity={0.15}/>
                    <stop offset="95%" stopColor="#f2b01e" stopOpacity={0}/>
                  </linearGradient>
                </defs>
                ...
                />
                <Area type="monotone" dataKey="revenue" stroke="#f2b01e" strokeWidth={3} fillOpacity={1} fill="url(#colorRevenue)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
