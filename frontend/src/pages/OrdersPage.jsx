                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6 }}>
                  ...
                  {order.yalidine_tracking && (
                    <div style={{
                      ...
                      📦 {order.yalidine_status || 'En cours de livraison'}
                    </div>
                  )}
                </div>
              </div>
              ...
              {order.yalidine_tracking && (
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
                    ...
                    <div>
                      <div style={{ fontWeight: 700, fontSize: '0.9rem', color: '#7c2d12' }}>Suivi Yalidine</div>
                      <div style={{ fontSize: '0.78rem', color: '#c2410c', fontWeight: 600 }}>
                        {order.yalidine_status || 'Colis pris en charge'}
                      </div>
                    </div>
                    {/* Indicateur animé si en cours */}
                    {order.yalidine_status && !['Livré', 'Retourné', 'Annulé'].some(s => order.yalidine_status.toLowerCase().includes(s.toLowerCase())) && (
                  ...
                  {(() => {
                    const s = (order.yalidine_status || '').toLowerCase()
                    const steps = [
                  ...
                  <div style={{
                    ...
                    <button
                      onClick={() => { navigator.clipboard?.writeText(order.yalidine_tracking); }}
