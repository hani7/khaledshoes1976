          ...
          <div key={order.id} className="track-card">
            ...
            <div className="track-card__body">
              ...
              {order.yalidine_tracking && (
                <div className="track-yalidine">
                  <div className="track-yalidine__header">
                    <span className="track-yalidine__label">🔍 Suivi Yalidine</span>
                    <span className="track-yalidine__barcode">{order.yalidine_tracking}</span>
                  </div>

                  {order.yalidine_status && (
                    <div className="track-yalidine__current">
                      Statut actuel : <strong>{order.yalidine_status}</strong>
                    </div>
                  )}
                  ...
                  {order.tracking_events && order.tracking_events.length > 0 ? (
                    ...
                    <p className="track-yalidine__no-events">
